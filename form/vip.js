		...
		if (self != top) {
			...
			try {
				...
				function jxbvipobj() {
					...
					const iqiyiapcliwaiobj = obj.match(/^https?:\/\/www\.iqiyi\.com\/(?:a_|kszt\/)/) && document.title.match(new RegExp("在线观看"));
					...
					const vipzdjxwzobj = (pcliwaiobj && !iqiyiapcliwaiobj) || sjliwaiobj;
						...
						if (localStorage.getItem("httpsjk") != null) {
							...
							if (jxbpcobj) {
								if (objj.match(/bilibili\./)) {
									...
									httpsjk = '18';
									localStorage.setItem("httpsjk", "18");
								} else {
									httpsjk = '4';
					...
					if (iqiyiapcliwaiobj) {} else if (pcliwaiobj || sjliwaiobj || jxjkobj && !objj.match(/jx\.x-99\./) || mmkjjtjobj || objj.match(/(?:douban|bilibili|acfun|douban|yinyuetai|kuwo|kugou|m1907|zuidazy\d*?|(?:y|kg)\.qq|xiami|migu|ximalaya|app-echo|1ting|pan\.baidu)\./)) {
						...
						cssobj('a[pb-click][target*="_blank"],[style^="position:fixed;bottom:0px"],[style^="position: fixed; bottom: 0px"],[style^="position:fixed;right: 0px"],[style^="position: fixed; right: 0px"],[class^="BAIDU_"],[id^="BAIDU_"],[data-appurl],[data-appurlios],[class*="Daoliu"],[id*="Daoliu"],section[class*="game"],section[id*="game"],[class*="detail_ad"],[id*="detail_ad"],[class*="layout_ad"],[id*="layout_ad"],[class*="ad ad_"],[id*="ad ad_"],[class*="qianfan"],[id*="qianfan"],iframe[width="960"][height="90"],[class*="AdPic"],[id*="AdPic"],[class^="vip-banner"],[id^="vip-banner"],[adata],html>head+body~div:not([style]):not([class]):not([id]),[class*="hongbao"],[id*="hongbao"],[ad-status],[class*=" cl ad_"],[id*=" cl ad_"],[class*=" cr ad_"],[id*=" cr ad_"],[class^="hd-ad"],[id^="hd-ad"],[class^="AD"],[class^="AD"],[id^="AD"],[id^="AD"],[class*="ad_microlen"],[id*="ad_microlen"],[class*="vip"][class*="guide"],[id*="vip"][id*="guide"],[width="300"][height="250"],[width="250"][height="300"],[src*=".cnzz."],[href*=".cnzz."]');
						let jxbscysobj = Array('[tj_id^="sb_"]', '[src*="/hm.js?"]', '[src*="?id=UA-"]', '[class$="-ie-tips"]', '[id$="-ie-tips"]', '[class*="miaozhenad"]', '[id*="miaozhenad"]', '[class*="BAIDU_DUP_"]', '[id*="BAIDU_DUP_"]', 'iframe[src*="/game/"]', '[width="250"][height="300"]', '[width="300"][height="250"]', '[class*="-ad-"][id*="banner"]', '[id*="-ad-"][id*="banner"]', 'iframe[width="1"][height="1"]', 'iframe[width="960"][height="90"]', 'iframe[class*="open"][class*="app"]', 'iframe[id*="open"][id*="app"]', '[class*="google"]', '[id*="google"]', '[name*="google"]', '[class*="cnzz"]', '[id*="cnzz"]', '[src*=".cnzz."]', '[href*=".cnzz."]', 'iframe[src]:not([src^="blob"]):not([src^="http"]):not([src^="/"])', 'gg', 'guanggao', 'ad', 'ads', 'adx', 'marquee');
						remove(jxbscysobj);
					} else {} if (jxjkobj || objj.match(/m1907\./)) {
						jzcopy();
						if (!objj.match(/(?:ufanw|jx\.13tv)\./)) {
							(function() {
					...
					function jxbmmanzxobj() {
						...
						(function() {
							let aa = 1, bb = '<span><a1 style="display:none"></a1><a2 style="display:none">', cc = '<span><a1 style="color:darkgreen">搜索</a1><a2 style="display:none">', dd = '<span><a1 style="color:darkgreen">跳转</a1><a2 style="display:none">', ee = '<span><a1 style="color:darkgreen">小窗</a1><a2 style="display:none">', ff = '<span><a1 style="color:darkgreen">大窗</a1><a2 style="display:none">', ii = '<span style="background-color:hotpink"><a1 style="color:darkgreen"></a1><a2 style="display:none">', kk = '<span style="display:grid;background-color:#2196f3"><a1 style="color:darkgreen">自用</a1><a2 style="display:none">', jj = '<span style="background-color:darkorange"><a1 style="color:darkgreen"></a1><a2 style="display:none">', gg = '</a2><a3 style="color:#2196F3;zoom:0.8;font-weight:bold;">➽</a3><a4>', hh = '</a2><a3 style="display:none"></a3><a4>', https = [{
								...
								name: ii + aa+++hh + "淘影",
								url: "https://jx.vodjx.top/?url="
							}, {
								name: ii + aa+++hh + "江湖",
								url: "https://v.jhdyw.vip/jhapi/?url=",
								vip: "&referer=https://v.jhdyw.vip"
							}, {
								name: bb + aa+++hh + "PAR",
								...
								name: ee + aa+++gg + "我爱",
								url: "https://vip.52jiexi.top/analysis.php?v=",
								vip: "强制弹小窗"
							}, {
								name: ee + aa+++gg + "爱跟",
								...
								for (var i = 0; i < https.length; i++) {
									...
									if (jxbpcobj) {} else {
										...
										httpsvipli.onclick = function() {
											try {
												(function() {
													if (!document.querySelector("pausetimer")) {
														document.body.appendChild(document.createElement("pausetimer"));
														try {
														...
														if (objj.indexOf('youku') > 0) {
															...
															function pciqiyidszx() {
																...
																if (!document.querySelector("白小江")) {
																	...
																	remove('div[style*="visibility"][style*="visible"]:not([class]):not([id]):not([style*="fixed"])');
																	cssobj('div[class*="player-side-ear"],div[class^="player-mnb"][data-asyn-pb],[class*="player"][class*="vip"][class*="popup"],[id*="player"][id*="vip"][id*="popup"]');
																}
															};
															...
															if (document.querySelector(vip)) {
																if (jxb.match(new RegExp("^https:\/\/(?!.+?强制(?:弹[小大]窗|跳转))")) && !jxb.match(new RegExp("(?:最大网|布米米|米侠)"))) {
																	if (objj.match('ixigua')) {
																		...
																		window.open(jxb, "bkmk_popup", "allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=" + (screen.availWidth - 7.5) + ",height=" + (screen.availHeight - 55));
																	} else if (pcliwaiobj && localStorage.getItem("jxywyfsgbobj") != null & !(sessionStorage.getItem("jxywygdfsgbobj") == '1')) {
																		if (localStorage.getItem("jxywyfsgbobj") == '1') {
																			document.querySelector(vip).innerHTML = tctha;
																			window.open(jxb, "bkmk_popup", "allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=" + (screen.availWidth - 7.5) + ",height=" + (screen.availHeight - 55));
																	...
																	} else if (!pcliwaiobj && https[num].name.match(new RegExp("无名"))) {
																	...
																	if (jxb.match(new RegExp("最大网"))) {
																		...
																		if (jxb.match(new RegExp("^https?:\/\/.+?强制跳转"))) {
																			...
																			tcthbobj();
																			window.open(jxb.replace(/强制弹大窗.*?$/, ""), "bkmk_popup", "allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=" + (screen.availWidth - 7.5) + ",height=" + (screen.availHeight - 55));
																			...
																			if (sessionStorage.getItem("jxyxkdfsgbobj") == '1') {
																				...
																				document.querySelector(vip).innerHTML = tctha;
																				window.open(jxb.replace(/强制弹小窗.*?$/, ""), "bkmk_popup", "allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=" + (screen.availWidth - 7.5) + ",height=" + (screen.availHeight - 55));
							...
							if (jxbpcobj) {
								...
								(function() {
									try {
										...
										let sjtzsjzdylwobj = /(?:爱跟|久已|蓝影|时光|大白|我爱|冰豆|师兄|麻瓜)/, sjyyyzdypbobj = /(?:淘影|老班|加速|酷看|猪蹄|七彩|久播|拉车|可乐|四七|无名|九八|乐多|恶灵|吉塔|福星|枫林|花园|大师|盖斯|CKP|M1907|H8|思[古云念]|蘑菇|OK|狼云|迪奥|618G|云端|老版|大白|147|256|365|920|973|1717|4080|8090|星驰|月亮|黑云|小蒋|九八|金桥|赤兔|诺讯)/i;
										for (let jxbqcsjjki = 0; jxbqcsjjki < jxbqcsjjk.length; jxbqcsjjki++) {
											...
											for (let jxbqcsjjkia = 0; jxbqcsjjkia < jxbqcsjjkmsa.length; jxbqcsjjkia++) {
												if (!localStorage.getItem("sjqbjkobj") == '1') {
													if (!jxbqcsjjk[jxbqcsjjki].innerText.match(sjtzsjzdylwobj) && jxbqcsjjkmsa[jxbqcsjjkia].innerText.match(/(?:搜索|跳转|[小大]窗)/)) {
														jxbqcsjjk[jxbqcsjjki].setAttribute('style', 'display:none!important')
													}
												} else {
													if (jxbqcsjjkmsa[jxbqcsjjkia].innerText.match(/(?:搜索)/)) {
														jxbqcsjjk[jxbqcsjjki].setAttribute('style', 'display:none!important');
													}
											...
											if (!localStorage.getItem("sjqbjkobj") == '1') {
												...
												for (let jxbqcsjjkib = 0; jxbqcsjjkib < jxbqcsjjkmsb.length; jxbqcsjjkib++) {
													let jkmcobj = jxbqcsjjkmsb[jxbqcsjjkib].innerText.match(sjyyyzdypbobj);
								...
								(function() {
									let jxbewj = '', jxbwjstyle = 'float:left;border-radius:3.5px;color:#000!important;box-shadow:inset rgba(255,254,255,.6) 0 0.3em 0.3em,inset rgba(0,0,0,.15) 0 -0.1em 0.3em,#d82661 0 0.1em 3px,#b7144a 0 0.3em 1px,rgba(0,0,0,.2) 0 0.5em 5px;background:0 0;font-weight:700;font-size:16px;padding:5px 2.5px 5px 2.5px;border:2.5px outset buttonface;text-decoration:none;background-color:#4CAF50;', jxbhttpsew = [{
										name: jxbewj + '<a style="' + jxbwjstyle + '" onclick="document.getElementById(\'jjxxkka\').style.display=\'none\';" href="https://gitee.com/q2257227289/00/raw/master/963540817-1.png" target="_blank">\u8d5e\u52a9</a>'
									}, {
										name: jxbewj + '<a style="' + jxbwjstyle + '" onclick="document.getElementById(\'jjxxkka\').style.display=\'none\';" href="https://jq.qq.com/?_wv=1027&k=OvyfwB9X" target="_blank">\u52a0\u7fa4</a>'
									}, {
										name: jxbewj + '<span id="sjzdwsobj" onclick="document.getElementById(\'jjxxkka\').style.display=\'block\';" style="' + jxbwjstyle + '">\u641c\u7d22</span>'
									}, {
									...
									function createSelectew(jxbhttpsew) {
										...
										document.body.insertAdjacentHTML('beforeend', '<style type="text/css">div[id^="jjxxkk"]{margin:0px;padding:0px;position:fixed;width:max-content;bottom:190px;left:50%;transform:translateX(-50%);z-index:102030;overflow:auto hidden;text-align:center;}div[id^="jjxxkk"]>span,div[id^="jjxxkk"]>a{float:left;border-radius:3.5px;color:#000!important;box-shadow:inset rgba(255,254,255,.6) 0 0.3em 0.3em,inset rgba(0,0,0,.15) 0 -0.1em 0.3em,#d82661 0 0.1em 3px,#b7144a 0 0.3em 1px,rgba(0,0,0,.2) 0 0.5em 5px;background:0 0;font-weight:700;font-size:16px;padding:5px 2.5px 5px 2.5px;border:2.5px outset buttonface;text-decoration:none;background-color:#4CAF50;}</style><div id="jjxxkka" style="display:none;"><span id="sjzdws">最大网</span><span id="sjzdwss">茶杯狐</span></div>');
											...
											if ((mgzdgq == 1 || mgzdgq == 2 || vipzdjx == 2) && vipzdjx != 1) {
												try {
													if (obj.match(/^https?:\/\/v(?:-wb)?\.youku\.com\/v_show\/id_/)) {
														...
														} else if ($('[class*="error-layer"]:contains("版权"):contains("加密"):contains("不支持"):contains("播放")')[0]) {
															document.querySelector("jiangxiaobai").remove();
															zddjobj();
															log("%c江小白-电脑-土豆会员自动解析-03-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
														} else {}
